...
namespace BM_Meals
{
    public partial class frmUserInfo : Form
    {
        ...
        {
            BMMealsDBContext BMMealsDC = new BMMealsDBContext();
           int OldPassword =   (from _User in BMMealsDC.Users
